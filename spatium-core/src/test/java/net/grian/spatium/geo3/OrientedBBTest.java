...
public class OrientedBBTest {
    ...
    public void get_simpleOBB() throws Exception {
        ...
        assertEquals(Vector3.fromAxis(Axis.X), box.getAxisX());
        assertEquals(Vector3.fromAxis(Axis.Y), box.getAxisY());
        assertEquals(Vector3.fromAxis(Axis.Z), box.getAxisZ());
    ...
    public void get_rotatedOBB() throws Exception {
        ...
        Vector3 expY = Vector3.fromAxis(Axis.Y);
