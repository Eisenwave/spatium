...
public class MatrixTest {
    ...
    public void rotationMatrix() {
        ...
        assertEquals(Matrix.fromRotX(deg90), Matrix.fromRot(Vector3.fromAxis(Axis.X), deg90));
        assertEquals(Matrix.fromRotY(deg90), Matrix.fromRot(Vector3.fromAxis(Axis.Y), deg90));
        assertEquals(Matrix.fromRotZ(deg90), Matrix.fromRot(Vector3.fromAxis(Axis.Z), deg90));
    }
