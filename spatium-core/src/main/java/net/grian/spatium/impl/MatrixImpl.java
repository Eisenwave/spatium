...
public class MatrixImpl implements Matrix {
    ...
    public MatrixImpl getCofactors() {
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < columns; j++) {
                ...
                result.set(i, j, FastMath.minusOnePow(i + j) * canvas.uncheckedDeterminant());
            }
        }
    ...
    /**
     * Pastes this matrix' values into the target matrix for each index <code>(i, j)</code> where:
     * <blockquote>
     * <code>i != row || j != col</code>
     * </blockquote>
     * <p>
     * The target matrix has to be at least <code>(m-1, n-1)</code> large, with m and n being the rows and columns
     * of this matrix.
     * </p>
     *
