...
public interface BlockVector extends Serializable, Cloneable {
    ...
    default void add(BlockVector block) {
        add(block.getX(), block.getY(), block.getZ());
    }

    abstract void subtract(int x, int y, int z);

    default void subtract(BlockVector block) {
        subtract(block.getX(), block.getY(), block.getZ());
    }

    abstract void multiply(int x, int y, int z);
    ...
    abstract void divide(int x, int y, int z);

    default void divide(int factor) {
