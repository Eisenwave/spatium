...
public class Curves {
    ...
    public static Vector bezier(double t, Vector a, Vector b) {
        return a.midPoint(b, t);
    }

    public static Vector bezier(double t, Vector a, Vector b, Vector c) {
        return bezier(t, bezier(t, a, b), bezier(t, b, c));
    }

    public static Vector bezier(double t, Vector... points) {
